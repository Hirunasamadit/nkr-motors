...
export const aboutCardsData = [
  {
    ...
    imageUrl: "/team.png",
    imageAlt: "NKR Motors team working on a vehicle",
    imageCaption: "Our Expert Team",
    imageSubcaption: "Certified technicians at work",
  },
  {
    ...
    imageAlt: "NKR Motors workshop facility with modern equipment",
    imageCaption: "Modern Workshop",
    imageSubcaption: "State-of-the-art equipment & tools",
  },
  {
    ...
    imageAlt: "Professional auto service in progress",
    imageCaption: "Quality Service",
    imageSubcaption: "Professional automotive care",
  },
];
